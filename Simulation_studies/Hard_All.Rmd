...
combined_plot <- plot_viterbi_triple(
  ...
  save_path = "Hard_std_Viterbi.png",
  width = 18,
  height = 6,
  dpi = 300
)
...
results <- baum_welch_triple_analysis(
  ...
  dt = 1/252,
  interval_step = 10,
  save_viterbi_path = "Hard_std_BW.png",
  save_ci_path = "Hard_std_CI.png",
  width = 18,
  height = 6,
  dpi = 300
)
...
out_om <- om_triple_analysis(
  ...
  save_viterbi_path = "Hard_OM_BW.png",
  save_ci_path = "Hard_OM_CI.png"
)
