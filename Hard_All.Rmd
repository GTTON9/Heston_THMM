...
# --- Build regime_params list in the format your simulate_heston_with_IV expects ---
regime_params <- list(
...
V_daily <- dat$v
RV_V <- dat$RV_V
RV_smooth <- lowess( RV_V, f = 0.03)$y
...
Data Visualization
```{r}
Hard_Path <- plot_price_and_variance_with_RV(S_daily, V_daily, RV_V, RV_smooth, True_State)
ggsave(
  filename = "Figure/Hard_Path.png",
  plot = Hard_Path,          
...
combined_plot <- plot_viterbi_triple(
  ...
  save_path = "Figure/Hard_std_Viterbi.png",
  width = 18,
  height = 6,
  dpi = 300
)
...
results <- baum_welch_triple_analysis(
  ...
  dt = 1/252,
  interval_step = 10,
  save_viterbi_path = "Figure/Hard_std_BW.png",
  save_ci_path = "Figure/Hard_std_CI.png",
  width = 18,
  height = 6,
  dpi = 300
)
...
om_results <- plot_viterbi_om_triple(
  ...
  save_path = "Figure/Hard_OM_Viterbi.png",
  width = 18,
  height = 6,
  dpi = 300
)
...
```{r}
RV_smooth <- lowess( RV_V, f = 0.001)$y
out_om <- om_triple_analysis(
  ...
  save_viterbi_path = "Figure/Hard_OM_BW.png",
  save_ci_path = "Figure/Hard_OM_CI.png"
)
